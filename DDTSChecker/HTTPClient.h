...
class CHTTPClient {
  static const char * DEFAULT_AGENT_NAME;
  static const char * HTTP_VERB_GET;
  static const char * HTTP_VERB_POST;
  static const char * HTTP_ACCEPT_TYPE;
  static const char * HTTP_ACCEPT;
...
public:
  ...
  void SetCredential(const std::string &user, const std::string &password) {
      m_user = user;
      m_password = password;
  }
};
